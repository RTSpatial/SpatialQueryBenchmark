 ...
 */
void shape_projection(geos::geom::Geometry *geom,
                      geos::geom::LineSegment segment, long double &dist_min,
 ...
 */
void curve_shape_projection(geos::geom::Geometry *geometry,
                            std::string curve_type, double cell_xmin,
                            double cell_ymin, double cell_x_intvl,
                            double cell_y_intvl, double &dist_start,
                            double &dist_end) {
  ...
  auto encoder =
      new Encoder<double>(cell_xmin, cell_x_intvl, cell_ymin, cell_y_intvl);
...
void curve_shape_projection(geos::geom::Envelope *envelope,
                            std::string curve_type, double cell_xmin,
                            double cell_ymin, double cell_x_intvl,
                            double cell_y_intvl, double &dist_start,
                            double &dist_end) {
