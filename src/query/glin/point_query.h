#ifndef SPATIALQUERYBENCHMARK_GLIN_POINT_QUERY_H
#define SPATIALQUERYBENCHMARK_GLIN_POINT_QUERY_H
#include "stopwatch.h"
#include "time_stat.h"
...
time_stat RunPointQueryGLIN(const std::vector<box_t> &boxes,
...
//time_stat RunParallelPointQueryGLIN(const std::vector<box_t> &boxes,
//                                     const std::vector<point_t> &queries,
//                                     const BenchmarkConfig &config) {
//  Stopwatch sw;
//  time_stat ts;
...
#endif // SPATIALQUERYBENCHMARK_GLIN_POINT_QUERY_H
